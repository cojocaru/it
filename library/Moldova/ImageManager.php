...
$file = $thumb->save("index.png", "png", 9);
$thumb->watermark($file, $valign, $halign, $vmargin, $hmargin);
$thumb->watermarkText($text, $color, $font, $valign, $halign, $vmargin, $hmargin);
$thumb->display("jpg", 85);
 */
 
class Moldova_ImageManager
{
