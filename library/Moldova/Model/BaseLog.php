...
Doctrine_Manager::getInstance()->bindComponent('Moldova_Model_Log', 'doctrine');

/**
 * Moldova_Model_BaseLog
 * 
 ...
 */
abstract class Moldova_Model_BaseLog extends Doctrine_Record
{
